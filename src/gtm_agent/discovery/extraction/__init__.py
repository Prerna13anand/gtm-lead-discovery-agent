...
Greenhouse, Lever, Ashby, Workable, SmartRecruiters, and JSON-LD are real
adapters against live APIs (see each module's docstring). Generic-HTML is
still a Phase 1 placeholder — the real heuristic-DOM implementation is later
Phase 2 work.
"""
